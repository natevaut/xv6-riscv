...
int main(int argc, char *argv[])
{
  ...
  1c:	320080e7          	jalr	800(ra) # 338 <ps>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 388:	46450513          	addi	a0,a0,1124 # 7e8 <digits>
 38c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 454:	398b8b93          	addi	s7,s7,920 # 7e8 <digits>
 ...
 594:	25090913          	addi	s2,s2,592 # 7e0 <malloc+0x10a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 65c:	1a87b783          	ld	a5,424(a5) # 800 <freep>
 ...
 68a:	00e6ea63          	bltu	a3,a4,69e <free+0x50>
{
 ...
 6cc:	12f73c23          	sd	a5,312(a4) # 800 <freep>
}
 6d0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 6fe:	10653503          	ld	a0,262(a0) # 800 <freep>
 ...
 726:	0de90913          	addi	s2,s2,222 # 800 <freep>
  if(p == (char*)-1)
 72a:	5afd                	li	s5,-1
 72c:	a88d                	j	79e <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 72e:	00000797          	auipc	a5,0x0
 732:	0da78793          	addi	a5,a5,218 # 808 <base>
 736:	00000717          	auipc	a4,0x0
 73a:	0cf73523          	sd	a5,202(a4) # 800 <freep>
 73e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 760:	0aa73223          	sd	a0,164(a4) # 800 <freep>
      return (void*)(p + 1);
